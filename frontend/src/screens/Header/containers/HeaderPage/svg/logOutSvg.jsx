...
export default function LogOutSvg() {
  return (
    <svg height="19" viewBox="0 0 24 24" width="21" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="m15.5 8c-.276 0-.5-.224-.5-.5v-5c0-.827-.673-1.5-1.5-1.5h-11.5c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h11.5c1.379 0 2.5 1.122 2.5 2.5v5c0 .276-.224.5-.5.5z" />
